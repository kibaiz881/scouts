 ...
 */
class getSokajyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SokajyRepository' shared autowired service.
     *
     * @return \App\Repository\SokajyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SokajyRepository.php';

        return $container->privates['App\\Repository\\SokajyRepository'] = new \App\Repository\SokajyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
