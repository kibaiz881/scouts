...
class getVichUploader_Listener_Remove_PostImageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.post_image'])) {
            return $container->privates['vich_uploader.listener.remove.post_image'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('post_image', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.remove.post_image'])) {
            return $container->privates['vich_uploader.listener.remove.post_image'];
        }

        return $container->privates['vich_uploader.listener.remove.post_image'] = $instance;
    }
}
