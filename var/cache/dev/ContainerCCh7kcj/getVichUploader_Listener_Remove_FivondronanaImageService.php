 ...
 */
class getVichUploader_Listener_Remove_FivondronanaImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.fivondronana_image' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.fivondronana_image'])) {
            return $container->privates['vich_uploader.listener.remove.fivondronana_image'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('fivondronana_image', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.remove.fivondronana_image'])) {
            return $container->privates['vich_uploader.listener.remove.fivondronana_image'];
        }

        return $container->privates['vich_uploader.listener.remove.fivondronana_image'] = $instance;
    }
}
