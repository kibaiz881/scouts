 ...
 */
class getFivondronanaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FivondronanaRepository' shared autowired service.
     *
     * @return \App\Repository\FivondronanaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FivondronanaRepository.php';

        return $container->privates['App\\Repository\\FivondronanaRepository'] = new \App\Repository\FivondronanaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
