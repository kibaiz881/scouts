 ...
 */
class getMpiandrakitraRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MpiandrakitraRepository' shared autowired service.
     *
     * @return \App\Repository\MpiandrakitraRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MpiandrakitraRepository.php';

        return $container->privates['App\\Repository\\MpiandrakitraRepository'] = new \App\Repository\MpiandrakitraRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
