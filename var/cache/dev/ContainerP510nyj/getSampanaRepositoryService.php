 ...
 */
class getSampanaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SampanaRepository' shared autowired service.
     *
     * @return \App\Repository\SampanaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SampanaRepository.php';

        return $container->privates['App\\Repository\\SampanaRepository'] = new \App\Repository\SampanaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
