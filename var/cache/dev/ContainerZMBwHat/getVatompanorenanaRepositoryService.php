 ...
 */
class getVatompanorenanaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VatompanorenanaRepository' shared autowired service.
     *
     * @return \App\Repository\VatompanorenanaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VatompanorenanaRepository.php';

        return $container->privates['App\\Repository\\VatompanorenanaRepository'] = new \App\Repository\VatompanorenanaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
