...
class __TwigTemplate_895dfd4f3c3c7d6bcf6a93df7e89c03b extends Template
{
...
\t\t\t\t\t\t</span>
\t\t\t\t\t\t<span class=\"text-muted\">Joined:
\t\t\t\t\t\t\t{{ currentUser.createdAt|date('F j, Y') }}</span>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
