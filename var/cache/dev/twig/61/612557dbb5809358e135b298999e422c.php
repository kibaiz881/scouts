...
class __TwigTemplate_6121620763bc65f35dea7fb3e08db1c0 extends Template
{
...
<div class=\"example-wrapper\">
    <H1>User Dashboard</H1>
        <h2>Welcome to the user dashboard! ";
        // line 9
...
<div class=\"example-wrapper\">
    <H1>User Dashboard</H1>
        <h2>Welcome to the user dashboard! {{ app.user.email }}</h2>
    <a href=\"{{ path('app_logout') }}\">Logout</a>
</div>
{% endblock %}
", "user/index.html.twig", "C:\\Users\\prodigy-188\\Music\\projet1\\templates\\user\\index.html.twig");
    }
}
