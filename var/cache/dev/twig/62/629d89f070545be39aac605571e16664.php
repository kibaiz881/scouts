...
/* admin/settingadmin/view.html.twig */
class __TwigTemplate_9de0c8a57d89277a59a7630ac00f524f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/settingadmin/view.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/settingadmin/view.html.twig"));
...
\t\t\t\t\t\t<img src=\"";
            ...
            yield "\" class=\"rounded me-2\" alt=\"logo\" width=\"20\">
\t\t\t\t\t\t<strong class=\"me-auto\">Helder Camara</strong>
...
\t\t\t\t\t";
        // line 57
        if ((($tmp = (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 57, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 58
            yield "\t\t\t\t\t\t<img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("images/profiles/" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 58, $this->source); })()), "profilePictureName", [], "any", false, false, false, 58))), "html", null, true);
...
\t\t\t\t\t<div class=\"user-name\">";
        // line 62
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 62, $this->source); })()), "username", [], "any", false, false, false, 62), "html", null, true);
        yield "</div>
\t\t\t\t\t<div class=\"user-title\">";
        // line 63
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 63, $this->source); })()), "fonctionScout", [], "any", false, false, false, 63), "html", null, true);
        yield "</div>
...
\t\t\t\t\t\t\t<span>";
        // line 71
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 71, $this->source); })()), "phone", [], "any", false, false, false, 71), "html", null, true);
        yield "</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"contact-item\">
...
\t\t\t\t\t\t\t<span>Scout ID: HC/AMI/-00";
        // line 75
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 75, $this->source); })()), "id", [], "any", false, false, false, 75), "html", null, true);
        yield "</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t";
        // line 84
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 84, $this->source); })()), "createdAt", [], "any", false, false, false, 84), "F j, Y"), "html", null, true);
        yield "</span>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
\t";
    ...
    {
        return "admin/settingadmin/view.html.twig";
    }
...
\t\t{# ✅ ICI : Messages flash en haut #}
\t\t\t<div class=\"toast-container position-fixed top-0 end-0 p-3\"> {% for message in app.flashes('success') %}

\t\t\t\t<div class=\"toast show\" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\">

\t\t\t\t\t<div class=\"toast-header\">
\t\t\t\t\t\t<img src=\"{{ asset('images/75hc.png') }}\" class=\"rounded me-2\" alt=\"logo\" width=\"20\">
\t\t\t\t\t\t<strong class=\"me-auto\">Helder Camara</strong>
\t\t\t\t\t\t<small class=\"text-muted\">now</small>
\t\t\t\t\t\t<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"toast\"></button>
\t\t\t\t\t</div>
...
\t\t\t</div>
\t\t\t<div class=\"page-actions\">
\t\t\t\t<a href=\"{{ path('admin_setting_edit', {'id': user.id}) }}\" class=\"btn-secondary\">
\t\t\t\t\t<i class=\"bi bi-pencil\"></i>Edit Profile
\t\t\t\t</a>
...
\t\t\t\t<div class=\"user-avatar\" id=\"userAvatar\">
\t\t\t\t\t{% if user %}
\t\t\t\t\t\t<img src=\"{{ asset('images/profiles/' ~ user.profilePictureName) }}\" alt=\"Photo de profil de {{ app.user.username }}\" class=\"avatar-img\" width=\"50\" height=\"50\" loading=\"lazy\">
\t\t\t\t\t{% endif %}
\t\t\t\t</div>
\t\t\t\t<div class=\"user-info\">
\t\t\t\t\t<div class=\"user-name\">{{ user.username }}</div>
\t\t\t\t\t<div class=\"user-title\">{{ user.fonctionScout }}</div>
\t\t\t\t\t<div class=\"user-contact\">
\t\t\t\t\t\t<div class=\"contact-item\">
\t\t\t\t\t\t\t<i class=\"bi bi-envelope\"></i>
...
\t\t\t\t\t\t<div class=\"contact-item\">
\t\t\t\t\t\t\t<i class=\"bi bi-building\"></i>
\t\t\t\t\t\t\t<span>Scout ID: HC/AMI/-00{{ user.id }}</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"d-flex align-items-center gap-3\">
\t\t\t\t\t\t<span class=\"user-status\">
...
\t\t\t\t\t\t</span>
\t\t\t\t\t\t<span class=\"text-muted\">Joined:
\t\t\t\t\t\t\t{{ user.createdAt|date('F j, Y') }}</span>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
{% endblock %}
", "admin/settingadmin/view.html.twig", "C:\\Users\\M_INFO\\Music\\scouts\\templates\\admin\\settingadmin\\view.html.twig");
    }
}
