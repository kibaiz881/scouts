 ...
 */
class getBeazinaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BeazinaRepository' shared autowired service.
     *
     * @return \App\Repository\BeazinaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BeazinaRepository.php';

        return $container->privates['App\\Repository\\BeazinaRepository'] = new \App\Repository\BeazinaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
